;CSKOS --- The CSK Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE CSK_OS_VER '1.0.0'	 ;OS version number
	%DEFINE CSK_OS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as CSK_OS and its programs
...
option_screen:
	...
	os_init_msg		db '~~~~~~~~~********************Welcome to CSK_OS********************~~~~~~~~~', 0
	os_version_msg		db 'Version ', CSK_OS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', CSK_OS_VER, 0

	dialog_string_1		db 'Welcome to CSK Operating System', 0
...
os_draw_background1:
	...
	mov cx, 11110000b		; Colour: white text on light blue
